...
export async function loadIcons() {
    const holders = document.querySelectorAll("[data-icon]");
...
export function initBottomNavScroll(threshold = 80) {
...
/* Krympande header */
export function initHeaderShrink(threshold = 60) {
...
/* Global init*/
export async function initGlobalUI() {
    setActiveNav();
    await loadIcons();
    initBottomNavScroll();
    initHeaderShrink();
