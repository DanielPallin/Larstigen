...
parentLoginForm?.addEventListener("submit", (e) => handleLogin(e, "parent-email", "parent-password"));
staffLoginForm?.addEventListener("submit", (e) => handleLogin(e, "email", "password"));
